class PostsController < ApplicationController
  ...
  def create
      ...
      respond_to do |format|
        if @post.save
          format.html { redirect_to post_url(@post), notice: "#{t('create.post')}"  }
  ...
  def update
    respond_to do |format|
      if @post.update(post_params)
        format.html { redirect_to post_url(@post), notice: "#{t('update.post')}"  }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to posts_url, notice: "#{t('destroy.post')}" }
    end
  end
