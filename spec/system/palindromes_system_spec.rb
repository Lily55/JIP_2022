...
RSpec.describe "application", type: :system do
  ...
  it "should return different results" do
    ...
    click_link 'Вернуться на страницу ввода'
    expect(page).to have_current_path input_path

    fill_in "num", with: 700
    click_button "Выполнить"
    expect(page).to have_current_path '/palindromes/view?num=700&commit=%D0%92%D1%8B%D0%BF%D0%BE%D0%BB%D0%BD%D0%B8%D1%82%D1%8C'


    # expect(num.result).not_to eq(num1.result)
  end
